...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 500px;">
            ...
            <h1 class="mb-4"> Join Our Community and Shape the Future Together!</h1>
        </div>
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <p class="text-center mb-4">Welcome to our community! Signing up opens the door to a
                    world of knowledge and collaboration. </p>
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    ...
                                    <label id="labelFullName" for="name">Full Name</label>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    ...
                                    <label id="labelPassword" for="message">Password</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-floating">
...
<script src="<?= APP_URL ?>/public/asset/js/signup.js"></script>