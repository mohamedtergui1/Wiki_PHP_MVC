        ...
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                    ...
                    <h1 class="display-4 text-white mb-4 animated slideInRight">Discover, Share, Learn: Your Wiki Journey Begins Here</h1>
                    <p class="text-white mb-4 animated slideInRight">Explore a collaborative haven of knowledge a Wiki , where enthusiasts share and discover 
                    ...
                    <a href="<?=APP_URL?>contact" class="btn btn-outline-light py-sm-3 px-sm-5 rounded-pill animated slideInRight">Contact Us</a>
                </div>
                <div class="col-lg-6 align-self-end text-center text-lg-end">
                    <img class="img-fluid" src="<?=APP_URL?>public/asset/img/hero-img.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container pt-5">
            <div class="row g-5">
                ...
                <div class="col-lg-6 align-self-end text-center text-md-end wow fadeIn" data-wow-delay="0.5s">
                    <img class="img-fluid" src="<?=APP_URL?>public/asset/img/feature.png" alt="">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="row g-4">
                                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">
                                        <img class="img-fluid rounded-circle p-4" src="<?=APP_URL?>public/asset/img/team-1.jpg" alt="">
                                ...
                                <div class="col-12 wow fadeIn" data-wow-delay="0.5s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">
                                        <img class="img-fluid rounded-circle p-4" src="<?=APP_URL?>public/asset/img/team-2.jpg" alt="">
                        ...
                        <div class="col-md-6 pt-md-4">
                            <div class="row g-4">
                                <div class="col-12 wow fadeIn" data-wow-delay="0.3s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">
                                        <img class="img-fluid rounded-circle p-4" src="<?=APP_URL?>public/asset/img/team-3.jpg" alt="">
                                ...
                                <div class="col-12 wow fadeIn" data-wow-delay="0.7s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">
                                        <img class="img-fluid rounded-circle p-4" src="<?=APP_URL?>public/asset/img/team-4.jpg" alt="">
